    ...
    return(
        <section className={styles.container}>
            ...
            <div className={styles.containerTexts}>
                <p>Há mais de 28 anos cuidando de pets com dedicação e carinho, nosso serviço de banho e tosa a domicílio nasceu para tornar a vida dos tutores mais prática e tranquila. <span>Cada atendimento é personalizado</span>, garantindo que seu pet receba atenção e cuidado com todo o conforto que merece.</p>
